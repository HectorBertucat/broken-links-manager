 ...
 */
 ...
 if ( ! class_exists( 'BLM_WP_Background_Process' ) ) {
	/**
	 * Abstract BLM_WP_Background_Process class.
	 *
	 * @abstract
	 * @extends BLM_WP_Async_Request
	 */
	abstract class BLM_WP_Background_Process extends BLM_WP_Async_Request {
